...
export const BigTile: FC<IBigTileProps> = ({title, info}: IBigTileProps) => {
  ...
  <div className='w-full lg:w-6/12 xl:w-3/12 px-4'>
    <div className='relative flex flex-col min-w-0 break-words bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-2 border border-gray-200'>
